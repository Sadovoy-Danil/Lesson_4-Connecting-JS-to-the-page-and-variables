...
В этос видеоуроке мы научились подключать JS к странице и сохранять данные внутри него, а также поговорили про переменные и их различия. Есть два способа подключения Script'а:
  1) В html ( _В отличие от стилей его можно подключать где угодно ;)_ )
  2) Непосредственно как отдельный документ ( _Для этого надо просто указать "путь" к Script'у_ )
  
![_**Стилестические правила**_](/img/code-style.jpg)
